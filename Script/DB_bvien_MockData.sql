...
/*==============================================================*/
/* DBMS name:      ORACLE Version 11g                           */
/* Created on:     8/28/2020 1:24:43 AM                         */
/*==============================================================*/
...
ALTER TABLE NHANVIEN
   DROP CONSTRAINT FK_NHANVIEN_REFERENCE_PHONGBAN;
...
GRANT INSERT, DELETE, UPDATE ON PHONGBAN, NHANVIEN, LICHTRUC;
GRANT SELECT ON CHITIETDICHVUHD, CHITIETTHUOCHD, THONGTINKHAMBENH, CUOCHOP, LICHTRUC, PHONG, LUONG, THUOC, DICHVU, NHANVIEN, BENHNHAN;
/
...
GRANT SELECT ON CHITIETDICHVU_HD TO TAI_VU;
GRANT UPDATE(THANHTIEN) ON CHITIETDICHVU_HD TO TAI_VU;
/

CREATE ROLE BAC_SI;
GRANT SELECT, UPDATE(TRIEUCHUNG, LOIDAN, PHONG) ON THONGTINKHAMBENH TO BAC_SI;
GRANT SELECT, UPDATE(SOLUONG, CACHDUNG), INSERT ON CHITIETTHUOC_HD TO BAC_SI;
GRANT SELECT, UPDATE, INSERT ON CHITIETDICHVU_HD TO BAC_SI;

/

CREATE ROLE BAN_THUOC;
GRANT SELECT, UPDATE(TONGGIA) ON DONTHUOC TO BAN_THUOC;
GRANT SELECT, UPDATE(DONGIA) ON DANH_SACH_DON_THUOC TO BAN_THUOC;
GRANT SELECT ON CHITIETTHUOC_HD TO BAN_THUOC;
/
